# Requires ggplot2 package to be installed and then loaded.
library(ggplot2)
# Loads RDS
...
# Aggregation of Emmissions for Baltimore City, Maryland
MD.DF <- aggregate(MD.onroad[, 'Emissions'], by = list(MD.onroad$year), sum)
colnames(MD.DF) <- c('year', 'Emissions')
MD.DF$City <- paste(rep('MD', 4))
# Aggregation of Emmissions for Los Angeles County, California
